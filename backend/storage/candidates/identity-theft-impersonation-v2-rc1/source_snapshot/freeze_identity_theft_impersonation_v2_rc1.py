"""Freeze development-passing Identity Theft & Impersonation V2 RC1."""
...
DATA = ROOT / "datasets" / "development" / "identity_theft_impersonation_v2_rc1" / "development.csv"
REPORT = ROOT / "reports" / "evaluation" / "identity_theft_impersonation" / "v2_rc1_development" / "report.json"
SOURCES = {
    ...
    "source_snapshot/freeze_identity_theft_impersonation_v2_rc1.py": Path(__file__).resolve(),
...
def main() -> None:
    ...
    required = {
        ...
        "processing_errors": 0, "real_identity_documents_used": False,
    ...
    try:
        ...
        raise
    print("IDENTITY THEFT & IMPERSONATION V2 RC1 FREEZE\n" + "=" * 60)
    ...
    print("V2 RC1 is frozen for one aggregate-only independent challenge.")
