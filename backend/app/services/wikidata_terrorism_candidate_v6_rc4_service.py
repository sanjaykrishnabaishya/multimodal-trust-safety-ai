...
def output(
    *,
    ...
    return {
        ...
        "candidate": "terrorism-extremism-v6-rc4-community-guard",
        "category": category,
        "status": status,
...
def analyze_wikidata_terrorism_candidate_v6_rc4(text: str) -> dict[str, object]:
...
def get_wikidata_terrorism_candidate_v6_rc4_status() -> dict[str, object]:
    return {
        "available": bool(load_candidate_index()),
        "candidate": "terrorism-extremism-v6-rc4-community-guard",
        "community_candidates_are_confirmed_designations": False,
