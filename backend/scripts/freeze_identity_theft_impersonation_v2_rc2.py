"""Freeze development-passing Identity Theft & Impersonation V2 RC2."""
...
DATA = ROOT / "datasets" / "development" / "identity_theft_impersonation_v2_rc2" / "development.csv"
REPORT = ROOT / "reports" / "evaluation" / "identity_theft_impersonation" / "v2_rc2_development" / "report.json"
SOURCES = {
    ...
    "source_snapshot/freeze_identity_theft_impersonation_v2_rc2.py": Path(__file__).resolve(),
...
def main() -> None:
    ...
    print("IDENTITY THEFT & IMPERSONATION V2 RC2 FREEZE\n" + "=" * 60)
    ...
    print("RC1 independent examples used for RC2: False")
    ...
    print("V2 RC2 is frozen for one aggregate-only independent challenge.")
