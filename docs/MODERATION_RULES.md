...
| Identity Theft & Impersonation | A current account, transaction, access, communication, benefit, loan, payment, or care impact is paired with deceptive impersonation or unauthorized use of identity, personal, financial, medical, login, or account material. | Restrict account activity and send for identity review. | Human review is mandatory and automatic suspension is disabled. Unknown identity, authorization, consent, provenance, authenticity, intent, or incomplete source evidence is Uncertain. Documented agents, verified official accounts, parody, fan content, fiction, reporting, education, prevention, research, and recovery are protected when there is no active misuse. A face, voice, name, photo, logo, resemblance, self-claim, or model score alone is never proof. |
